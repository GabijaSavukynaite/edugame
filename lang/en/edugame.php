...
$string['edugame:edit'] = 'Edit test';
$string['edugame:enrol'] = 'Enrol users';
$string['edugame:manage'] = 'Manage users';
$string['edugame:unenrol'] = 'Unenrol users';
$string['edugame:view'] = 'View test';
...
$string['modulename'] = 'Edu game';
$string['modulename_help'] = 'Use the newmodule module for...';
$string['modulenameplural'] = 'Edu game';
...
$string['newmodulename'] = 'Edu game name';
